package com.yesway.izhijia.telephony;
...
public class MyPhoneSignalStateListener extends PhoneStateListener {

	/*  For illustrate the member attr.
	("SignalStrength:"					0
	...
	private SignalStrengthLevelListener listener = null;
	...
	public interface SignalStrengthLevelListener {
	...
	public void onSignalStrengthsChanged(SignalStrength signalStrength) {
		...
		attr = signalStrength.toString().split(" ");
		sStrength = signalStrength;
		
		int level = getLevel();
		if (getListener() != null && level != signalLevel){
			getListener().getSignalStrengthLevel(level);
		}
	...
	public void setListener(SignalStrengthLevelListener listener) {
		this.listener = listener;
	}
	
	public SignalStrengthLevelListener getListener() {
		return listener;
	}
