...
public class UserManager {
	...
	private UserInfo parseLoginMsg(String is){
		...
		try {
			...
			Log.d("userManager", "sessionid:"+sessionID);
			...
			info.setZjid(zjid);
			info.setUsername(infoObj.getString("username"));
			...
			info.setProvince(infoObj.getString("province"));
			info.setCity(infoObj.getString("city"));
			info.setCounty(infoObj.getString("county"));
			info.setTel1(infoObj.getString("tel1"));
			...
			Log.d("userManager", "userinfo:"+info.toString());
